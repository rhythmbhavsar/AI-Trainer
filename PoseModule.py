...
class poseDetector():
    def __init__(self, mode=False, model_complexity=1, smooth=True, enable_seg=False, smooth_seg=True, detectCon=0.5,
                 trackCon=0.5):
        self.mode = mode
        ...
        self.pose = self.mpPose.Pose(self.mode, self.model_complexity, self.smooth, self.enable_seg, self.smooth_seg,
